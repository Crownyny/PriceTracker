...
class BaseSource(ABC):
    ...
    def user_agent(self) -> Optional[str]:
        """
        User-Agent HTTP que Playwright usará para esta fuente.
        Si es None, se utiliza el UA global del scraper.
        Sobreescribir en fuentes cuyos servidores bloqueen el UA por defecto.
        """
        return None
